...
const Activities = () => {
  ...
  const addActivity = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://oldcare-connect-8ctq.vercel.app/api/activities', newActivity);
  ...
  const deleteActivity = async (id) => {
    try {
      ...
      await axios.delete(`https://oldcare-connect-8ctq.vercel.app/api/activities/${id}`);
  ...
  const fetchActivities = async (activityType) => {
    try {
      ...
      const response = await axios.get('https://oldcare-connect-8ctq.vercel.app/api/activities', {
